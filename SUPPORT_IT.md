...
**Perché alcuni file sono stati ignorati?**
Molto probabilmente il rilevamento dei duplicati li ha riconosciuti come già presenti (stessa dimensione e stesso contenuto nella cartella di destinazione). La finestra di dialogo mostra entrambi i file a confronto diretto; puoi anche disattivare il controllo con «Controlla i duplicati».

**Posso annullare una rinomina?**
Sì — subito dopo l'operazione, premi ⌘Z (Modifica → Annulla). I file copiati vengono spostati nel Cestino; i file spostati tornano alla loro posizione originale.
...
Quando segnali un problema, descrivi brevemente la modalità scelta, la struttura delle cartelle e l'azione (copia/spostamento) — questo rende molto più facile individuare la causa.
